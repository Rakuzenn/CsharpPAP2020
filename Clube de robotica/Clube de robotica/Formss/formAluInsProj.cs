...
namespace Clube_de_robotica
{
    public partial class formAluInsProj : Form
    {
        ...
        public void insert()
        {
            ...
            if (dt.Rows.Count >= 1 )
            {
                MessageBox.Show("Alunos ja esta inserido no projecto");
            }
            else
            {
                ...
                //    mail.Body = "<h2>Foi inserido num novo projecto, Para mais informações verifique a aplicação do Clube.</h2>";
